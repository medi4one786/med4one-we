          ...
          <div className="space-y-6 md:space-y-0 border-t border-primary/5 pt-6 md:border-none md:pt-0">
            <details className="md:block group" open>
              ...
              <ul className="space-y-4 pt-2 md:pt-0">
                ...
                <li><Link to="/vision-mission" className="text-muted-foreground hover:text-primary transition-colors">Vision &amp; Mission</Link></li>
                <li><Link to="/founders" className="text-muted-foreground hover:text-primary transition-colors">Founders</Link></li>
                <li><Link to="/team" className="text-muted-foreground hover:text-primary transition-colors">Team</Link></li>
                <li><Link to="/press-kit" className="text-muted-foreground hover:text-primary transition-colors">Press Kit</Link></li>

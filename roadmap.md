...
- [x] About Us + Vision & Mission pages (footer links), premium homepage style
- [x] Real login/account (email + password) and session-aware navigation
- [x] Book a Demo: real submission stored in Med4One, consent + anti-spam
